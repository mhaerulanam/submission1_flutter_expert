...
class DetailTvSeriesModel extends Equatable{
  ...
  factory DetailTvSeriesModel.fromJson(Map<String, dynamic> json) => DetailTvSeriesModel(
    adult: json["adult"],
    backdropPath: json["backdrop_path"],
    createdBy: List<CreatedByModel>.from(json["created_by"].map((x) =>
        CreatedByModel.fromJson(x))),
    ...
    name: json["name"],
    nextEpisodeToAir: TEpisodeToAirModel.fromJson(json["next_episode_to_air"]),
