...
class TvSeriesRepositoryImpl implements TvSeriesRepository {
  ...
  @override
  Future<Either<Failure, DetailTvSeries>> getTvSeriesDetail(int id) async {
    try {
  ...
  @override
  Future<Either<Failure, String>> saveWatchlistTvSeries(DetailTvSeries tvSeries) async {
    try {
      final result =
  ...
  @override
  Future<Either<Failure, String>> removeWatchlistTvSeries(DetailTvSeries tvSeries) async {
    try {
      final result =
