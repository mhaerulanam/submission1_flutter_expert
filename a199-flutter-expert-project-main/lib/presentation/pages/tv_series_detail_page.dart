...
class DetailContentTvSeries extends StatelessWidget {
  ...
  DetailContentTvSeries(this.tvSeries, this.recommendationsTvSeries, this.isAddedWatchlistTvSeries);
                                  ...
                                  return Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        final tvSeries = recommendationsTvSeries[index];
                                        return Padding(
                                      ...
                                      itemCount: recommendationsTvSeries.length,
                                    ),
                                  );
                                } else {
                                  return Container();
